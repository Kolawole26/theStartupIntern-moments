...
function Register({firstLinks, fullname, setFullname, email, setEmail, password, setPassword, RegisterSubmit, errorFullname, errorEmail, errorPassword, errorRegister}) {
